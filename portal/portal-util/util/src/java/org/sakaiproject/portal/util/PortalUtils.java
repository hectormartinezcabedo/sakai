	...
	public static String includeLatestJQuery(String where)
	{
        String retval = 
             ...
             "   document.write('\\x3Cscript type=\"text/javascript\" src=\"" +
                 "\">'+'\\x3C/script>')\n" +
             "   document.write('\\x3Cscript type=\"text/javascript\" src=\"" +
                 getWebjarsPath() + "jquery-ui/1.14.2/jquery-ui.min.js" + getCDNQuery() + 
                 "\">'+'\\x3C/script>')\n" +
             "   document.write('\\x3Clink rel=\"stylesheet\" href=\"" +
                 getWebjarsPath() + "jquery-ui/1.14.2/jquery-ui.min.css" + getCDNQuery() + 
                 "\"/>')\n" +
             "} else { \n" +
             ...
             "           document.write('\\x3Cscript type=\"text/javascript\" src=\"" + getWebjarsPath() + "jquery-ui/1.14.2/jquery-ui.min.js" + getCDNQuery() + "\">'+'\\x3C/script>')\n" +
             "           document.write('\\x3Clink rel=\"stylesheet\" href=\"" + getWebjarsPath() + "jquery-ui/1.14.2/jquery-ui.min.css" + getCDNQuery() + "\"/>')\n" +
