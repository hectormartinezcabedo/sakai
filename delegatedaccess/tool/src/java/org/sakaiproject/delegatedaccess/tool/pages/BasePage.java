...
public class BasePage extends WebPage implements IHeaderContributor {
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(JavaScriptHeaderItem.forUrl("/library/webjars/jquery-ui/1.14.2/jquery-ui.min.js"));

		//for datepicker
		response.render(CssHeaderItem.forUrl("/library/webjars/jquery-ui/1.14.2/jquery-ui.css"));
